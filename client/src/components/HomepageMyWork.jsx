...
export default function HomepageMyWork({ tasks, deleteTask, editTask, userID, state }) {
  ...
  return (
    <div className="homepage-my-work">
      ...
      {tasks[0] && <TaskList tasks={tasks} deleteTask={deleteTask} editTask={editTask} userID={userID} state={state}/>}
