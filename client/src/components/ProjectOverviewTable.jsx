...
export default function ProjectOverviewTable({ state, projectID, projectTasks, projectUsers, deleteTask, editTask, userID, addTask }) {
          ...
          <TableBody>
            {projectTasks[0] &&
              rows.map((row) => (
                ...
                <StyledTableCell align="center" style={{ backgroundColor: backgroundColor[row.status], color: '#fcfcfc' , fontSize: '15px'}}>{row.status && row.status.toUpperCase()}</StyledTableCell>
