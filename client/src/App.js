...
function App() {
  const { state, loading, deleteTask, addTask, updateTaskStatus, getKanbanStatus, kanbanStatus, addProject, deleteProject, updateProjectUsers, updateTaskPriority } = useApplicationData();
